...
//		drawAttackBox(g, lvlOffset);
	...
	private void drawAttackBox(Graphics g, int lvlOffsetX) {
		...
		g.drawRect((int)attackBox.x - lvlOffsetX - 20 ,
				(int)attackBox.y,(int)
				(attackBox.width), 
	...
	private void drawUI(Graphics g) {
		g.drawImage(statusBarImg, statusBarX, statusBarY,(int) (healthBarWidth * 1.5), healthBarHeight * 15, null);
		g.setColor(Color.red);
		g.fillRect(healthBarXStart + statusBarX + 5, healthBarYStart + statusBarY, healthWidth + 30, healthBarHeight);
